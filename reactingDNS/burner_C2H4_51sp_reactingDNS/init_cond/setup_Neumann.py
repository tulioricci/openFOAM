...
for spc in gas.species_names:
    ...
    spcName = spc[:]
    if re.search(r'-', spc):
        spcName = spc.replace("-","minus")
    if re.search(r'\*', spc):
        spcName = spc.replace("*","star")
    ...
    os.system("echo '        name            my" + spcName + "Inlet;' >> " + spc)
    os.system("echo '        redirectType    my" + spcName + "inlet;' >> " + spc)
    os.system("echo '' >> " + spc)
    ...
    os.system("echo '            const volScalarField& Diffi = db().lookupObject<volScalarField>(\"Diff" + spc + "\"); // const' >> " + spc)
    ...
    os.system("echo '        refGradient     uniform 0;' >> " + spc)
    os.system("echo '        valueFraction   uniform 1;' >> " + spc)
    os.system("echo '        name            my" + spcName + "Shield;' >> " + spc)
    os.system("echo '        redirectType    my" + spcName + "shield;' >> " + spc)
    os.system("echo '' >> " + spc)
    os.system("echo '        code' >> " + spc)
    os.system("echo '        #{' >> " + spc)
    os.system("echo '            // Reference value at the boundary' >> " + spc)
