...
mat_location = burner_height + 0.020;  //arbitrary value
...
aux = 0.5*(burner_base_radius + ext_radius);
Point(61) = {     0.0, 0.235,     0.0, 0.0010};
Point(62) = {  r4*cos, 0.235,  r4*sin, 0.0015};
Point(63) = { burner_base_radius*cos, 0.235, burner_base_radius*sin, 0.0015};
...
If (mesh_type == 2)
    //10 um
    Transfinite Line {22,-24,-79,-80} = 141 Using Progression 1.014;
    ...
    Transfinite Line {-78} = 191 Using Progression 1.010;
    Transfinite Line { 68} = 191 Using Progression 1.007;
