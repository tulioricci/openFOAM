...
for spc in gas.species_names:
    ...
    os.system("echo '' >> " + spc)
    os.system("echo '            const volScalarField& alpha = db().lookupObject<volScalarField>(\"thermo:alpha\");' >> " + spc)
    os.system("echo '' >> " + spc)
    ...
    os.system("echo '' >> " + spc)
    os.system("echo '                scalar alphaVal = alpha.boundaryField()[boundaryPatch.index()][faceI];' >> " + spc)
    os.system("echo '' >> " + spc)
