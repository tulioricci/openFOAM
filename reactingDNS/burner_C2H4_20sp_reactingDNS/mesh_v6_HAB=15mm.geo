...
aux = 0.5*(burner_base_radius + ext_radius);
Point(61) = {     0.0, 0.230,     0.0, 0.0010};
Point(62) = {  r4*cos, 0.230,  r4*sin, 0.0015};
Point(63) = { burner_base_radius*cos, 0.230, burner_base_radius*sin, 0.0015};
...
If (mesh_type == 2)
    //10 um
    Transfinite Line {22,-24,-79,-80} = 95 Using Progression 1.02;
    ...
    Transfinite Line {-78} = 145 Using Progression 1.010;
    Transfinite Line { 68} = 145 Using Progression 1.005;
