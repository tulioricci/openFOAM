...
mat_location = burner_height + 0.005;  //arbitrary value
...
aux = 0.5*(burner_base_radius + ext_radius);
Point(61) = {     0.0, 0.220,     0.0, 0.0010};
Point(62) = {  r4*cos, 0.220,  r4*sin, 0.0015};
Point(63) = { burner_base_radius*cos, 0.220, burner_base_radius*sin, 0.0015};
...
If (mesh_type == 2)
    //10 um
    Transfinite Line {22,-24,-79,-80} = 12 Using Progression 1.15;
    ...
    Transfinite Line {-78} = 62 Using Progression 1.018;
    Transfinite Line { 68} = 62 Using Progression 1.005;
    Transfinite Line {-50,52,53,-58,59,-60} = 51 Using Progression 1.06;
