...
Point(101) = {ext_radius*cos, burner_height-0.645*0.0254, ext_radius*sin, 1.0};
Point(102) = {mid_radius*cos, burner_height-0.645*0.0254, mid_radius*sin, 1.0};
Point(103) = {int_radius*cos, burner_height-0.645*0.0254, int_radius*sin, 1.0};
Point(104) = {        r4*cos, burner_height-0.645*0.0254,         r4*sin, 1.0};
Point(105) = {            0., burner_height-0.645*0.0254,             0., 1.0};
...
Transfinite Line { 90, 91,92, 93} = 55 Using Progression 1.10;
Transfinite Line { 97} = 17 Using Bump 0.6;
Transfinite Line {-95} = 33 Using Progression 1.015;
Transfinite Line {-94} = 41 Using Progression 1.002;

Line Loop(9) = {2,5,93,94,95,-92};
Plane Surface(9) = {9};
Transfinite Surface {9} = {5,3,103,105};
Recombine Surface(9);

Line Loop(10) = {7,91,97,-90};
Plane Surface(10) = {10};
...
Physical Surface("f_front") = {1:15};
Physical Surface("f_back") = {144,176,200,232,274,301,323,370,397,419,436,458,480,502,519};
Physical Surface("outlet") = {131};
Physical Surface("farfield") = {135,139};
Physical Surface("burner") = {143,245,284,310};
Physical Surface("plate") = {396,410,418};
Physical Surface("shield") = {414};
Physical Surface("fuel") = {388,392};
Physical Surface("sample") = {427,453,479,493,518};
Physical Volume("flow") = {1:8,11:15};
Physical Volume("porosity") = {9,10};
