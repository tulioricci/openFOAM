...
{
    // dynamicCode:
    // SHA1 = 2ce9caed4037c267ac87bf9266e55bdc7b5c431c
    //
    // Unique function name that can be checked if the correct library version
    // has been loaded
    void EulerImplicit_chemistryModel_polynomial_janaf_perfectGas_specie___sensibleInternalEnergy____2ce9caed4037c267ac87bf9266e55bdc7b5c431c(bool load)
    {
        if (load)
        {
...
#define ThermoPhysics                                                          \
    polynomialTransportsensibleInternalEnergyjanafThermoperfectGasspecie
...
namespace Foam
{
    ...
    makeChemistrySolver(EulerImplicit, chemistryModel, ThermoPhysics);
}

#define chemistryModelCppTest 0

#if chemistryModelCppTest == chemistryModelCppTest
