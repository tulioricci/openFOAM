...
Point(24) = {           0., mat_location,           0., 1};
Point(23) = { 0.015875*cos, mat_location, 0.015875*sin, 1};
Point(22) = { 0.015875*cos, mat_location + 0.01, 0.015875*sin, 1};
Point(21) = { 0.015875*cos, mat_location + 0.10, 0.015875*sin, 1};
Point(20) = {           0., mat_location + 0.10,           0., 1};

mat_BL = 0.003;
Point(25) = {                      0.,  - mat_BL + mat_location,                      0., 2*cl_w};
Point(26) = { (0.015875 + mat_BL)*cos,  - mat_BL + mat_location, (0.015875 + mat_BL)*sin, 1};
Point(27) = { (0.015875 + mat_BL)*cos,           + mat_location + 0.01, (0.015875 + mat_BL)*sin, 0.5*cl_w};
Point(28) = { (0.015875 + mat_BL)*cos,  + mat_BL + mat_location + 0.10, (0.015875 + mat_BL)*sin, 0.5*cl_w};
Point(29) = {                      0.,  + mat_BL + mat_location + 0.10,                      0., 2*cl_w};
...
Transfinite Line {-30} = 5 Using Progression 1.025;
...
Physical Surface("wall") = {170,188,218,238};
Physical Surface("farfield") = {77,81};
