...
Transfinite Line { 23} = 27 Using Progression 1.00;
Transfinite Line {-51} = 27 Using Progression 1.008;
/*Transfinite Line { 71} = 27 Using Progression 1.015;*/

Transfinite Line { 22} = 7 Using Progression 1.0;
/*vertical*/
...
Physical Surface("outlet") = {124};
Physical Surface("farfield") = {128,132};
Physical Surface("burner") = {136,207,229};
Physical Surface("shield") = {146};
