...
Point(16) = {         0.0,            mat_location + 1.*mat_holder,           0., 1.0};
Point(17) = {         0.0, mat_BL_y + mat_location + 1.*mat_holder,           0., clM};

Point(20) = {                   0.0, radius,                     0., 0.66*cl2};
...
Point(51) = {insulator_wide*cos, mat_location + insulator, insulator_wide*sin, 1.0};
Point(52) = {               0.0, mat_location + insulator,                 0., 1.0};
Point(53) = {               0.0, mat_location + mat_thick,                 0., 1.0};
Point(54) = {insulator_wide*cos, mat_location + mat_thick, insulator_wide*sin, 1.0};
Point(55) = {insulator_wide*cos, mat_location + delta_mat, insulator_wide*sin, 1.0};
Point(56) = {               0.0, mat_location + delta_mat,                 0., 1.0};
Point(57) = {insulator_wide*cos, mat_location + mat_holder - mat_BL_y, insulator_wide*sin, 1.0};
Point(58) = {               0.0, mat_location + mat_holder - mat_BL_y,                0.0, 1.0};
...
Transfinite Line { 23} = 29 Using Progression 1.00;
Transfinite Line {-51} = 29 Using Progression 1.008;
Transfinite Line { 71} = 29 Using Progression 1.015;
Transfinite Line {-68} = 29 Using Progression 1.015;
Transfinite Line { 66} = 29 Using Progression 1.015;
Transfinite Line { 75} = 29 Using Progression 1.015;

Transfinite Line { 57} = 29 Using Progression 1.0;
Transfinite Line {-29} = 29 Using Progression 1.01;

Transfinite Line { 22} = 13 Using Progression 1.00;
/*vertical*/
...
Transfinite Line { 54} = 25 Using Progression 1.003;
Transfinite Line { 70} = 25 Using Progression 1.00;
Transfinite Line { 63} = 25 Using Progression 1.00;

Transfinite Line { 27} = 25 Using Progression 1.04;
Transfinite Line { 55} = 25 Using Progression 1.04;
Transfinite Line { 69} = 25 Using Progression 1.04;
Transfinite Line {-67} = 25 Using Progression 1.04;


Transfinite Line { 65} = 13 Using Progression 1.1;
Transfinite Line {-76} = 13 Using Progression 1.1;
Transfinite Line { 62} = 13 Using Progression 1.1;
...
Transfinite Line {-28} = 15 Using Progression 1.002;
Transfinite Line {-56} = 15 Using Progression 1.02;
Transfinite Line { 74} = 15 Using Progression 1.0;
Transfinite Line { 73} = 15 Using Progression 1.0;
...
/*Point(83) = {  0.350, burner_height + 0.320, 0., 4.500*clF};*/
/*Point(84) = {  0.350, burner_height + 0.360, 0., 5.000*clF};*/
/*Point(85) = {  0.350, burner_height + 0.400, 0., 5.500*clF};*/
/*Point{70:85} In Surface{1};*/

y0 = burner_height + flame_dist;
Point(70) = {  0.065, y0 + 0.000, 0., 1.250*clF_2};
Point(71) = {  0.070, y0 + 0.005, 0., 1.500*clF_2};
Point(72) = {  0.075, y0 + 0.010, 0., 1.625*clF_2};
Point(73) = {  0.080, y0 + 0.020, 0., 1.750*clF_2};
Point(74) = {  0.085, y0 + 0.040, 0., 1.875*clF_2};
Point(75) = {  0.090, y0 + 0.060, 0., 2.000*clF_2};
Point(76) = {  0.095, y0 + 0.080, 0., 2.000*clF_2};
Point{70:76} In Surface{1};
...
/*Graphite*/
Line Loop(21) = {-66,74,75,-73};
Plane Surface(21) = {-21};
Transfinite Surface {21};
Recombine Surface(21);

Line Loop(22) = {64,55,62,-69};
Plane Surface(22) = {-22};
Transfinite Surface {22};
Recombine Surface(22);

Line Loop(23) = {-62,56,-76,-74};
Plane Surface(23) = {-23};
Transfinite Surface {23};
Recombine Surface(23);

Line Loop(24) = {-75,76,57,65};
Plane Surface(24) = {-24};
...
Extrude {{0,1,0}, {0,0,0}, 2*Pi/frac} { Surface{22}; Layers{1}; Recombine; }
Extrude {{0,1,0}, {0,0,0}, 2*Pi/frac} { Surface{23}; Layers{1}; Recombine; }
Extrude {{0,1,0}, {0,0,0}, 2*Pi/frac} { Surface{24}; Layers{1}; Recombine; }
...
Physical Surface("farfield") = {144,148};
Physical Surface("outlet") = {140};
Physical Surface("burner") = {152,245,223};
Physical Surface("shield") = {162};
Physical Surface("fuel") = {196,209};
Physical Surface("f_front") = {1:6,11:15};
Physical Surface("f_back") = {153,175,197,214,236,258,275,297,319,341,358};
Physical Surface("s_front") = {16,17,18};
Physical Surface("s_back") = {375,397,414};
Physical Surface("a_front") = {20};
Physical Surface("a_back") = {431};
Physical Surface("g_front") = {21,22,23,24};
Physical Surface("g_back") = {448,470,492,509};
Physical Volume("flow") = {1:11};
Physical Volume("porousMat") = {12:14};
Physical Volume("alumina") = {15};
Physical Volume("graphite") = {16:19};
