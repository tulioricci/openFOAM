...
If (mesh_type == 1)
    ...
    Transfinite Line { 3, 4, 6, 16} = 51 Using Progression 1.05;
    Transfinite Line { 13} = 53 Using Progression 1.02;
    Transfinite Line { 10} = 53 Using Progression 1.00;
    Transfinite Line {-78} = 63 Using Progression 1.018;
    Transfinite Line { 68} = 63 Using Progression 1.005;
    Point(104) = {0.0, 0.000005 + burner_height, int_radius*sin, 1.0};
    Point(105) = {0.0, mat_location - 0.000025 , int_radius*sin, 1.0};
    Transfinite Line {-50,52,53,-58,59,-60} = 27 Using Progression 1.100;
EndIf

If (mesh_type == 2)
    //10 um
    Transfinite Line {22,-24,-79,-80} = 53 Using Progression 1.04;
    Transfinite Line { 3, 4, 6, 16} = 51 Using Progression 1.025;
...
Transfinite Line { 100} = 29 Using Progression 1.005;
...
Transfinite Line { -94} = 11 Using Progression 1.066;
Transfinite Line {-102} = 11 Using Progression 1.066;
Transfinite Line {  91} = 11 Using Progression 1.066;
...
/*Sample*/
Line Loop(16) = {100,101,93,98};
Plane Surface(16) = {16};
/*Recombine Surface(16);*/

Line Loop(17) = {100,102,54,-94};
Plane Surface(17) = {-17};
Transfinite Surface {17} Left;
Recombine Surface(17);

Line Loop(18) = {102,-51,91,-101};
Plane Surface(18) = {18};
Transfinite Surface {18} Right;
Recombine Surface(18);

/*Alumina*/
Line Loop(20) = {96,97,98,99};
Plane Surface(20) = {-20};
/*Recombine Surface(20);*/

/*Graphite*/
Line Loop(21) = {56,57,95,-96,-99,94,55};
Plane Surface(21) = {-21};
...
Physical Surface("burner") = {148,250,289,315};
Physical Surface("f_back") = {149,181,205,237,279,306,328,375,392,414,436,458,475};
Physical Surface("fuel") = {195,236};
Physical Surface("shield") = {278};
Physical Surface("s_front") = {16:18};
Physical Surface("s_back") = {492,514,531};
Physical Surface("a_front") = {20};
Physical Surface("a_back") = {548};
Physical Surface("g_front") = {21};
Physical Surface("g_back") = {580};
Physical Volume("flow") = {1:13};
Physical Volume("porousMat") = {14:16};
Physical Volume("alumina") = {17};
Physical Volume("graphite") = {18};
