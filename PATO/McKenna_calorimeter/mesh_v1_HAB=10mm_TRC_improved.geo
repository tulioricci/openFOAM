...
x7 = 0.35*25.4/2000;
y3 = 0.063*25.4/1000;
Point(79) = {  (x4-d)*cos, mat_location+0.013208-y3-d, (x4-d)*sin, 2*clM/2.0};
Point(80) = {  (x6-d)*cos, mat_location+0.013208-y3-d, (x6-d)*sin, 2*clM/2.0};
Point(81) = {  (x6-d)*cos, mat_location+0.013208 + d, (x6-d)*sin, 2*clM/2.0};
Point(82) = {  (x4-d)*cos, mat_location+0.013208 + d, (x4-d)*sin, 2*clM/2.0};

Point(86) = {   x7*cos, mat_location+0.013208-y3, x7*sin, 0.0015};
Point(87) = {   x6*cos, mat_location+0.013208-y3, x6*sin, 0.0015};
Point(88) = {   x6*cos, mat_location+0.013208, x6*sin, 0.0015};
Point(89) = {   x7*cos, mat_location+0.013208, x7*sin, 0.0015};
Point(90) = {  (0.00626783)*cos, mat_location+0.005588,   (0.00626783)*sin, 0.7*clS};
Point(91) = {  (0.00697835)*cos, mat_location+0.005588,   (0.00697835)*sin, 0.7*clS};
Point(92) = {  (0.00697835)*cos, mat_location+0.013208,   (0.00697835)*sin, 0.7*clS};
Point(93) = {  (0.00626783)*cos, mat_location+0.013208,   (0.00626783)*sin, 0.7*clS};
Point(94) = {  (0.00697835)*cos,          mat_location,   (0.00697835)*sin, 0.7*clS};
...
Transfinite Line {-51} = 8 Using Progression 1.01;
Transfinite Line {-48} = 25 Using Progression 1.01;
...
Transfinite Line { 60, -75} =  8 Using Progression 1.05;
Transfinite Line {61,-63,65,-101,103} = 28 Using Progression 1.01;
Transfinite Line { 64, 102, 120} = 3 Using Progression 1.0;
//Transfinite Line { 66, 104} = 71 Using Progression 1.01;
//Transfinite Line { 104} = 71 Using Progression 1.01;
Transfinite Line { 66, 121} = 5 Using Progression 1.01;
Transfinite Line { 68, 125} = 64 Using Progression 1.01;
...
Transfinite Line { 77, 122} = 7 Using Progression 1.0;
Transfinite Line { 78, 123} = 5 Using Progression 1.0;
Transfinite Line { 79, 124} = 7 Using Progression 1.0;
...
Line Loop(9) = {49,50,51,48,52,-23};
Plane Surface(9) = {9};
Transfinite Surface {9} = {10,12,41,9};
Recombine Surface(9);

Line Loop(10) = {62,63,64,65,66,77,78,79,68,69,70,71,118,-107,-106,-105,-125,-124,-123,-122,-121,-103,-102,-101,-100,-110};
Plane Surface(10) = {-10};
Transfinite Surface {10} = {55,78,70,51};
Recombine Surface(10);

Line Loop(11) = {101,102,103,-120};
Plane Surface(11) = {-11};
Transfinite Surface {11};
Recombine Surface(11);

Line Loop(12) = {100,120,121,122,123,124,125,105,106,107,119};
Plane Surface(12) = {-12};

// Slug
Line Loop(13) = {-50, 60, 61, 62, 63, 75};
Plane Surface(13) = {13};
Transfinite Surface {13} = {10,51,52,11};
Recombine Surface(13);

Transfinite Line {80,82} = 3;
Transfinite Line {81,83} = 20;
Transfinite Line {85} = 5;
Transfinite Line {84} = 16;

// Holder
Line Loop(14) = {85,-79,-78,-77,-66,-65,-64,75,51,-84,-80,-83};
Plane Surface(14) = {-14};

// Body
Line Loop(15) = {68,69,70,71,67,-57,-56,-55,-54,-48,-84,81,82,85};
Plane Surface(15) = {15};

// Graphite 
Line Loop(16) = {80,81,82,83};
Plane Surface(16) = {-16};
...
Physical Surface("f_front") = {1:12};
Physical Surface("outlet") = {163};
Physical Surface("farfield") = {167,171};
Physical Surface("burner") = {175,267,291,309};
Physical Surface("f_back") = {176,208,255,292,346,363,385,417,444,566,588,640};
Physical Surface("fuel") = {313,316};
Physical Surface("shield") = {345};
Physical Surface("s_front") = {13};
Physical Surface("s_back") = {664};
Physical Surface("h_front") = {14};
Physical Surface("h_back") = {726};
Physical Surface("b_front") = {15};
Physical Surface("b_back") = {793};
Physical Surface("g_front") = {16};
Physical Surface("g_back") = {815};
Physical Volume("flow") = {1:12};
Physical Volume("slug") = {13};
Physical Volume("holder") = {14};
Physical Volume("body") = {15};
