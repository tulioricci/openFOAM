...
Point(1)  = {              0.001*cos, burner_height        ,              0.001*sin, 1.0};
Point(2)  = {         ext_radius*cos, burner_height        ,         ext_radius*sin, 1.0};
Point(3)  = {              0.001*cos, burner_height + 0.005,              0.001*sin, 2*cl_w};
...
mat_BL = 0.003;
Point(25) = {               0.001*cos,  - mat_BL + 0.115,               0.001*sin, 2*cl_w};
...
Point(29) = {               0.001*cos,  + mat_BL + 0.215,               0.001*sin, 2*cl_w};
...
Transfinite Line {-1} = 51 Using Progression 1.025;
Transfinite Line { 5} = 51 Using Progression 1.025;
...
Transfinite Line {-30} =  9 Using Progression 1.0;
...
Point(104) = {int_radius*cos,   0.000100 + burner_height, int_radius*sin, 1.0};
